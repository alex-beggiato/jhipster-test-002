...
@RestController
@RequestMapping("/api/jhipster-test-002-kafka")
public class JhipsterTest002KafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterTest002KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterTest002KafkaResource(KafkaProperties kafkaProperties) {
