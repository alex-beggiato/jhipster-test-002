...
import org.test.config.KafkaProperties;
import org.testcontainers.containers.KafkaContainer;
import org.testcontainers.utility.DockerImageName;

class JhipsterTest002KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterTest002KafkaResource kafkaResource = new JhipsterTest002KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-test-002-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-test-002-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
